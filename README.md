# project-terraform-web-application : Phonebook Application (Python Flask) deployed on AWS Application Load Balancer with Auto Scaling and Relational Database Service using Terraform
...
![project-terraform-web-application](tf-phonebook.png)
...
- Step 1: Download or clone project definition from `ompayat/project-terraform-web-application` repo on Github 
